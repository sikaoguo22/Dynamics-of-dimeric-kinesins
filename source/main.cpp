...
{
	string par_temp;
    ifstream parin("./in_par.txt");
    parin >> par_temp >> intseed >> par_temp >> expcount >> par_temp >> Edock_kt \
	>> par_temp >> fload >> par_temp >> fload_y >> par_temp >> limping;
    parin.close();
    
    intseed=-9131;Edock_kt=4.5;fload=-4.0;fload_y=9.0;

    ofstream out_x("./x.dat");
    ofstream out_t("./t.dat");
	ofstream out_xf("./xf.dat");
    ofstream out_tf("./tf.dat");    
    ofstream out_x0("./x0.dat");
    ofstream out_t0("./t0.dat");
    ofstream out_x1("./x1.dat");
    ofstream out_t1("./t1.dat");
    ofstream out_x0_f("./x0f.dat");
    ofstream out_t0_f("./t0f.dat");
    ofstream out_x1_f("./x1f.dat");
    ofstream out_t1_f("./t1f.dat");
